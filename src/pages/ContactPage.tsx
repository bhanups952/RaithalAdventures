...
import {
  MapPin, Phone, Mail, Clock, Send, MessageCircle, Navigation, Car, Train, Plane
} from 'lucide-react';
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        {/* Contact Info & WhatsApp QR Side by Side */}
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
          ...
          {/* WhatsApp QR Code */}
          <div className="bg-emerald-50 rounded-lg p-6 h-fit">
        ...
        <div className="mt-16 relative rounded-xl overflow-hidden h-[400px] shadow-md">
          ...
          <div className="absolute bottom-4 right-4 pointer-events-auto">
            <button
              ...
              className="bg-emerald-600 text-white px-10 py-4 rounded-lg font-medium hover:bg-emerald-700 transition-colors duration-200 inline-flex items-center gap-2 shadow-lg"
            >
